...
Script is located on our CDN and is available here: [https://cdn.xsolla.net/embed/buy-button/3.1.7/widget.min.js](https://cdn.xsolla.net/embed/buy-button/3.1.7/widget.min.js). Use this URL to integrate script on your website.
...
<script>
    ...
    s.async = true;
    s.src = "//cdn.xsolla.net/embed/buy-button/3.1.7/widget.min.js";
...
``` javascript
<script src="//cdn.xsolla.net/embed/buy-button/3.1.7/widget.min.js"></script>
<script>
