...
Script is located on our CDN and is available here: [https://static.xsolla.com/embed/pay2play/1.0.2/widget.min.js](https://static.xsolla.com/embed/pay2play/1.0.2/widget.min.js). Use this URL to integrate script on your website.
...
<script>
    ...
    s.async = true;
    s.src = "//static.xsolla.com/embed/pay2play/1.0.2/widget.min.js";
...
``` javascript
<script src="//static.xsolla.com/embed/pay2play/1.0.2/widget.min.js"></script>
<script>
